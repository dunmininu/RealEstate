...
class SearchView(APIView):
  ...
  def post(self, request, format=None):
    ...
    if price == '#0+':
      ...
      price = 20000000
    elif price == '#40,000,000+':
      price = 40000000
    elif price == '#60,000,000+':
      price = 60000000
    elif price == '#80,000,000+':
      price = 80000000
    elif price == '#100,000,000+':
      price = 100000000
    elif price == '#120,000,000+':
      price = 120000000
    elif price == '#140,000,000+':
      price = 140000000
    elif price == '#180,000,000+':
      price = 180000000
    elif price == '#200,000,000+':
      price = 200000000
    elif price == '#250,000,000+':
      price = 250000000
    elif price == '#300,000,000+':
      price = 300000000
    elif price == '#350,000,000+':
      price = 350000000
    elif price == 'Any':
      price = -1
    ...
    for query in queryset:
      ...
      if days_passed != 0 :
        if num_days > days_passed:
          slug = query.slug
          queryset = queryset.exclude(slug_iexact = slug)
    ...
    queryset = queryset.filter(desciption__icontains=keywords)
